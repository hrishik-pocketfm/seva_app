...
urlpatterns = [
    ...
    path('temple/seva/', views.all_seva_list, name='all_seva_list'),
    ...
    path('temple/devotees/<int:pk>/delete/', views.delete_devotee, name='delete_devotee'),
    ...
    path('temple/special-dates/<int:pk>/delete/', views.delete_special_seva_date, name='delete_special_seva_date'),
    path('temple/seva/new/', views.seva_event_new, name='seva_event_new'),
    path('temple/seva/<int:pk>/delete/', views.delete_seva_event, name='delete_seva_event'),
